...
from .polygon_classification_dialog import PolygonClassificationDialog
import os.path


class PolygonClassification:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'PolygonClassification_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Polygon Classification')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('PolygonClassification', message)
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginVectorMenu(
                self.tr(u'&Polygon Classification'),
                action)
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg = PolygonClassificationDialog()
